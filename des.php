...
require_once("include/getDes.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Kids_Des Movies</title>
...
<div class="container">
    ...
    <div class="mySlides">
        ...
        <img src="image/desni.jpg" style="width:100%;height:450px">
    </div>
                                    ...
                                    <div class="product-item">
                                        <div class="pi-pic">
                                            ...
                                            <ul>
                                                ...
                                                <li class="quick-view"><a href="DesDe.php?id=<?=$product['product_id']?>">+ Quick View</a></li>
                                            </ul>
