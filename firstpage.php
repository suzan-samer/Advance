                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="user-panel">
                        <div class="up-item">
                            ...
                            <a style="text-decoration: none;outline: none" href="personal.php">My Account</a> <i class="fas fa-heart"style="color: darkred"></i><a style="text-decoration: none;outline: none"href="Wishlist.php"> Fav</a><i class="fas fa-sign-out-alt"style="color: black"></i><a style="text-decoration: none;outline: none" href="f.php"> LogOut</a>
                        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="firstpage.php">All Movies</a>
                        </li>
                        <li class="nav-item">
        ...
        <div id='login-form'class='login-page'>
            <div class="form-box">
                ...
                <form id='login' class='input-group-login' action='loginProcess.php' method='post'>
                    ...
                    <input type='checkbox'class='check-box'><spann>Remember Password</spann>
...
<section class='latest'>
    <h4 style="margin-top: 100px; margin-bottom:40px; padding-left: 10px ;font-family: 'Segoe Print';font-size: 50px;color: white">Popular Movie</h4>
    <div class="row">
...
<section class='shows'>
    <h4 style="margin-top: 100px; margin-bottom:40px; padding-left: 10px ;font-family: 'Segoe Print';font-size: 50px;color: white"> All Movies</h4>
...
<section class='showws'>
    <h4 style="margin-top: 100px; margin-bottom:40px; padding-left: 385px ;font-family: 'Segoe Print';font-size: 50px;color: white"> Movie Night</h4>
    <div class="row">
                ...
                <div class="roow">
                    <div class="col-md-12">
                        <div class="hot-deal">
                            ...
                            <h2 class="text-uppercase" style="color: #FFFFFF">The most famous movie ever.. </h2>
...
<section class='shh' >
    ...
    <br>
    <h4 style="margin-top: 100px; margin-bottom:40px; padding-left: 10px ;font-family: 'Segoe Print';font-size: 50px;color: white"> Categories</h4>
