...
require_once("include/getHorror.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container">
    ...
    <div class="mySlides">
        ...
        <img src="image/ho.jpg" style="width:100%;height:450px">
    </div>
                                    ...
                                    <div class="product-item">
                                        <div class="pi-pic">
                                            ...
                                            <ul>
                                                ...
                                                <li class="quick-view"><a href="HoDe.php?id=<?=$product['product_id']?>">+ Quick View</a></li>
                                            </ul>
