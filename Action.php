...
require_once("include/getMov.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container">
    ...
    <div class="mySlides">
        ...
        <img src="image/d.jpg" style="width:100%;height:450px">
    </div>
                                ...
                                <div class="product-item">
                                    <div class="pi-pic">
                                        ...
                                        <ul>
                                            ...
                                            <li class="quick-view"><a href="detail.php?id=<?=$product['product_id']?>">+ Quick View</a></li>
                                        </ul>
