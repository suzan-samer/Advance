...
require_once("include/getRomance.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container">
    ...
    <div class="mySlides">
        ...
        <img src="image/rr.jpg" style="width:100% ;height:450px">
    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-8 order-2 order-lg-1 produts-sidebar-filter">
                    <div class="filter-widget">
                        ...
                        <ul class="filter-catagories">
                            ...
                            <li><a href="Drama.php">Comedy Movie</a></li>
                        </ul>
                    </div>
                                    ...
                                    <div class="product-item">
                                        <div class="pi-pic">
                                            ...
                                            <ul>
                                                ...
                                                <li class="quick-view"><a href="RoDe.php?id=<?=$product['product_id']?>">+ Quick View</a></li>
                                            </ul>
