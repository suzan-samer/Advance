...
<main>
<h3 style="margin-top: 50px;color: darkred;font-family: cursive;text-align: center"> My Personal Information </h3>
                    <table width="84%"style="margin-left: 110px; margin-top: 120px;margin-bottom: 200px">
                        <tbody>
                           <tr>
                               <th>
                                   Email
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget">
                        ...
                        <div class="contact-info">
                            <p><i class="fa fa-map-marker"></i>Palestine,Nabluse</p>
                            <p><i class="fa fa-envelope"></i>suzansamer772@gmail.com</p>
                            <p><i class="fa fa-phone"></i>+972-0568805494</p>
                        </div>
                    </div>
                </div>
